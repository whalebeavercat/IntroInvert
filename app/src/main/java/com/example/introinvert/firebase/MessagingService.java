package com.example.introinvert.firebase;
...
import com.example.introinvert.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        builder.setContentTitle(user.name + " sent you a message!");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            String channelDescription = "Chat Message Channel";
